            ...
            <div class="span8">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <g:form action="insertSubCategory" class="form-horizontal" params="${}">
                        ...
                        %{--</div>--}%
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="mask-phone" class="span8 mask text" name="code" value="">
                                </div>
                            </div>
                            <!-- <div class="control-group">
				...
				<input type="text" id="mask-phoneInt" class="span8 mask text">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="mask-phoneExt" class="span8 mask text" name="name" value="">
                                </div>
                            </div>
                            <!-- <div class="control-group">
				...
				<div class="controls">
					<input type="text" id="mask-phoneInt" class="span8 mask text">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="textarea_editor span8" rows="6" placeholder="Enter text ..." name="desc"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="${createLink(controller: 'subCategory',action: 'viewSubCategory')}" class="btn btn-danger">Cancel</a>
                            </div>
                        </g:form>
                    </div>
                </div>
