                            ...
                            <div class="leftData colDataBlk">
                                <div class="colDataSection noBorder">
                                    <div class="colDataInnerBlk">
                                        <g:set var="subcategoryMap" value="${category?.getAt(category)}"/>
                                        <g:set var="subcategories" value="${subcategoryMap?.keySet()}"/>
                                        <g:each in="${subcategories}" var="subcategory">
                                            ...
                                            <g:set var="products" value="${subcategoryMap?.getAt(subcategory)}"/>
